...
NOTE: When adding the CHAI assignments to the SingleCellExperiment object, it is crucial to use the word ```"_assign"``` in the column as we have done below, or else the evaluation_function will not recognize it as a clustering assignment column. 
